...
import com.mywebmanager.swings.JComponents.Label.LabelText;
...
public class ConfiguracionArchivo implements Constantes {
    ...
    public static void setDatabse(String JDBC_DRIVER, String BD_URL, String USER, String PASS) {
        Properties properties = new Properties();
        properties.setProperty("JDBC_DRIVER", JDBC_DRIVER);
        properties.setProperty("BD_URL", BD_URL);
    ...
    public static Database getDatabase(Database database) {
        Properties properties = new Properties();
        
        try (InputStream input = new FileInputStream("DB.properties")) {
            properties.load(input);

            database.setJDBC_DRIVER(properties.getProperty("JDBC_DRIVER"));
            database.setBD_URL(properties.getProperty("BD_URL"));
            database.setUSER(properties.getProperty("USER"));
            database.setPASS(properties.getProperty("PASS"));
