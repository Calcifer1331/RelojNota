...
public class Inicio extends javax.swing.JPanel implements AlarmaListener, Timbre.TimbreListener {
    ...
    private void initComponents() {
        ...
        labelHeader1.setFont(new java.awt.Font("Segoe UI", 1, 36));
        ...
        textAreaNota.setFont(new java.awt.Font("Segoe UI Semibold", 0, 19));
        scrollPanel1.setViewportView(textAreaNota);

        TitleNodo.setText("Notas");
        TitleNodo.setFont(new java.awt.Font("Segoe UI", 1, 36));
